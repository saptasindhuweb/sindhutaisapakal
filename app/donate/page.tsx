...
const Donate = () => {
    ...
    return (
        <>
            <main className="w-full bg-[#ffffff]  pb-20 max-sm:hidden">
            ...
            {/* ================= MOBILE DONATE PAGE ================= */}
            <main className="w-full bg-white md:hidden">
                ...
                >
                    ...
                    <div className="relative h-full flex flex-col justify-center px-6">
                        ...
                        <p className="text-white text-sm mb-6">
                            Your donation helps us provide food, shelter and education.
                        </p>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        {step === "amount" && (
                            <>
                                ...
                                <div className="flex justify-center gap-4 mb-6">
                                    <button
                                        onClick={() => setType("one-time")}
                                        className={`px-4 py-2 rounded-lg text-sm border ${type === "one-time"
                                    ...
                                    <button
                                        onClick={() => setType("monthly")}
                                        className={`px-4 py-2 rounded-lg text-sm border ${type === "monthly"
                                                ? "bg-sky-500 text-white"
                                                : "border-gray-300 text-gray-600"
                                            }`}
                                    >
                                ...
                                <div className="grid grid-cols-2 gap-3 mb-6">
                                    {presetAmounts.map((amt) => (
                                        <button
                                            key={amt}
                                            onClick={() => setAmount(amt)}
                                            className={`border rounded-lg py-2 text-sm ${amount === amt
                                                    ? "border-yellow-400 bg-yellow-50"
                                                    : "border-gray-300"
                                                }`}
                                        >
                                ...
                                <button
                                    ...
                                    className="w-full bg-sky-500 text-white py-3 rounded-lg font-semibold active:scale-95 transition"
                                >
                                    Proceed To Donate
                                </button>
                            </>
                        ...
                        {step === "details" && (
                            <>
                                ...
                                <button
                                    onClick={handleDonate}
                                    className="w-full mt-6 bg-sky-500 text-white py-3 rounded-lg font-semibold active:scale-95 transition"
                                >
                                    Proceed To Donate
                                </button>
                            </>
                ...
                <section className="bg-white py-12 px-4">
                    ...
                    <p className="text-sm text-gray-700 mb-6">
                        If facing issues with the form, please use the QR code or bank details below.
                    </p>

                    <div className="text-sm text-gray-700 space-y-2 mb-8">
                        <p><strong>Bank:</strong> State Bank of India, Hadapsar Branch</p>
                        <p><strong>IFSC:</strong> SBIN0006319</p>
                        <p><strong>Account No:</strong> 00000042543704360</p>
                    </div>
