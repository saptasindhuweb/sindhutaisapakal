            ...
            <main className="bg-white  md:hidden">
                ...
                <section className="py-4 px-4">
                    ...
                    <p className="text-xs text-gray-600 mb-6">
                        ...
                        In charge: Mamata Sindhutai Sapakal
                    </p>
                    ...
                    <div className="text-gray-700 text-sm leading-relaxed space-y-4 text-justify">
                        <p>
                            Sanmati Bal Niketan in Manjari, Pune supports underprivileged
                            children by providing food, shelter, clothing, education and
                            rehabilitation in a secure environment.
                        </p>
                        <p>
                            The organization ensures education for school-going children and
                            maintains supervision for their overall well-being.
                        </p>
                        <p>
                            Cultural programs during festivals like Diwali and Ganesh
                            Festival promote holistic development and social integration.
                        </p>
                        <p>
                            Admissions are regulated through the Child Welfare Committee.
                            Children aged 6+ are accepted without discrimination.
                        </p>
                    </div>
