...
const Contact = () => {
  ...
  return (
    <>
      ...
      {/* ================= MOBILE CONTACT PAGE ================= */}
      <main className="w-full mb-12 px-4 bg-white md:hidden">
        ...
        <section className="pt-4 pb-12">
          ...
          <h1 className="text-lg font-bold leading-snug">
            "देवा, आम्हाला हसायला शिकव… पण आम्ही कधी रडलो होतो,
            याचा विसर पडू देऊ नकोस..!"
          </h1>
            ...
            <div className="relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Full Name"
                  className="w-full rounded-lg px-4 py-3 text-sm outline-none bg-white/90 border border-gray-200 focus:border-black transition"
                />
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Your opinion"
                  className="w-full rounded-lg px-4 py-3 text-sm outline-none resize-none h-24 bg-white/90 border border-gray-200 focus:border-black transition"
                />

                <button
                  type="submit"
                  className="w-full bg-sky-500 text-black py-3 rounded-lg font-semibold active:scale-95 transition shadow-md"
                >
                  Submit
                </button>
        ...
        <section>
          ...
          <div className="space-y-6 text-sm">
            ...
            <div className="flex items-start gap-3">
              <MdLocationOn className="text-xl text-yellow-500 mt-1 flex-shrink-0" />
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <MdPhone className="text-lg text-yellow-500" />
                <span>+91 93710 74256</span>
              </div>
              <div className="flex items-center gap-3">
                <MdPhone className="text-lg text-yellow-500" />
                <span>+91 97308 31701</span>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <MdMail className="text-lg text-yellow-500" />
